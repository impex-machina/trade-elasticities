...
producing 6,830,718 (importer, exporter, HS4) cell-level γ estimates with
...
- **Standard errors: conditional on σ, with a robustness screen.** `gamma_se`
  ...
  9.4% are boundary, plateau, non-converged, or unflagged fits. The pipeline
